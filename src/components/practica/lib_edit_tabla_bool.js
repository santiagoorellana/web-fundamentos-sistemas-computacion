...
Autor=Santiago Orellana P�rez 
Fecha=23/12/2009
*/

//*******VARIABLES CONSTANTES*********************
var  o_and='*'; //S�mbolo para el operador AND
      o_or='+'; //S�mbolo para el operador OR
     o_not='-'; //S�mbolo para el operador NOT
    lineas=0;   //Cantidad de l�neas de la tabla. 
       FDN=0;
       FCN=1;
...
//X=Cadena de entrada 
//Y=M�scara de asignaci�n de valores a las variables.
...
//---------------------------------------------------------
//Devuelve el producto estandar PE de una evaluaci�n.
//x=resultado de la f�rmula para la combinaci�n dada en y. Aqu� se devuelve el PE (producto estandar)
...
//---------------------------------------------------------
//Devuelve la suma estandar SE de una evaluaci�n.
//x=resultado de la f�rmula para la combinaci�n dada en y. Aqu� se devuelve el PE (producto estandar)
//Y=contiene los bits correspondientes a cada variable
//z=contiene la cantidad de variables
...
chr=new Array(8,'A','B','C','D','E','F','G','H');
num_var_usadas=document.getElementById("s1").selectedIndex+1;  //Aqu� se cambia la cantidad de variables
if(num_var_usadas>5)
...
if(lineas!=1){
  ...
  for(n=0;n<lineas;n++){
     ...
     bin=asig_val(bin,lineas-n-1,chr);           //Le asigna valor num�rico a las variables devolviendo el resultado en un arreglo.
...
//---------------------------------------------------------
//Muestra la funci�n en forma can�nica 
...
if(v1==''){
  alert('En este caso particular, no se puede utilizar el m�todo matem�tico seleccionado.');
  return 0;};
